...
<div class = "dlogging"> 
    ...
    <a href="Donor login page.php">
    <button type="button" class="donorlogin">DONOR LOGIN</button>
    </a>
</div>

<div class = "slogging"> 
    <a href="staff login page.php">
    <button type="button" class="stafflogin">STAFF LOGIN</button>
    </a>
</div>
